 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "lorn2.com", ownerName = "lorn2.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyD-cnCZdAl__qFQ5s1AYJb9rXzb6nHZxRg";
