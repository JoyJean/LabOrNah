 ...
 * on 2014-12-08 at 19:09:00 UTC 
 * Modify at your own risk.
 */

package com.lorn2.deviceinfoendpoint;
...
public class Deviceinfoendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetDeviceInfo extends DeviceinfoendpointRequest<com.lorn2.deviceinfoendpoint.model.DeviceInfo> {
    ...
    protected GetDeviceInfo(java.lang.String id) {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.lorn2.deviceinfoendpoint.model.DeviceInfo.class);
   ...
   * operation.
   *
   * @param content the {@link com.lorn2.deviceinfoendpoint.model.DeviceInfo}
   * @return the request
   */
  public InsertDeviceInfo insertDeviceInfo(com.lorn2.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    InsertDeviceInfo result = new InsertDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class InsertDeviceInfo extends DeviceinfoendpointRequest<com.lorn2.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected InsertDeviceInfo(com.lorn2.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "POST", REST_PATH, content, com.lorn2.deviceinfoendpoint.model.DeviceInfo.class);
    }
  ...
  public class ListDeviceInfo extends DeviceinfoendpointRequest<com.lorn2.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
    ...
    protected ListDeviceInfo() {
      super(Deviceinfoendpoint.this, "GET", REST_PATH, null, com.lorn2.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
    }
   ...
   * @return the request
   */
  public UpdateDeviceInfo updateDeviceInfo(com.lorn2.deviceinfoendpoint.model.DeviceInfo content) throws java.io.IOException {
    UpdateDeviceInfo result = new UpdateDeviceInfo(content);
    initialize(result);
    return result;
  }

  public class UpdateDeviceInfo extends DeviceinfoendpointRequest<com.lorn2.deviceinfoendpoint.model.DeviceInfo> {
     ...
     * @since 1.13
     */
    protected UpdateDeviceInfo(com.lorn2.deviceinfoendpoint.model.DeviceInfo content) {
      super(Deviceinfoendpoint.this, "PUT", REST_PATH, content, com.lorn2.deviceinfoendpoint.model.DeviceInfo.class);
    }
